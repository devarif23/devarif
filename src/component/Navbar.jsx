...
const GradientNavbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="px-4 mx-auto max-w-7xl">
          <div className="flex items-center justify-between h-16">
            ...
            <Link
              to="/"
              className="flex   items-center transition-all duration-500 hover:scale-105 mt-1"
            >
              <img
                src="/arifjahan01.png"
                width={200}
                  ...
                  >
                    <Icon
                      className={`w-5 h-5 transition-all duration-500 ${
                        isActive
                          ? "scale-110 text-[#0F475D]"
                          : "group-hover:scale-110 group-hover:text-[#0F475D]"
                      }`}
                    />
                    <span
            ...
            {navItems.slice(0, 5).map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`mt-0.5 text-xs font-medium transition-all duration-500 ${
                      isActive ? "text-white" : "group-hover:text-white"
                    }`}
                  >
                    {item.label}
      ...
      {/* Content Padding */}
      <div className="pt-16 pb-20 lg:pb-0">{/* Your content here */}</div>
    </>
  );
};
