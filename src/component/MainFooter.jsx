...
const MainFooter = () => {
    return (
        < >
        {/*  <div className="bg-green-900   mb-96" >
         <footer className="w-[1320px] m-auto footer sm:footer-horizontal text-neutral-content flex  items-center md:justify-between p-4 text-white">
...
<footer className="bg-gray-900 md:w-full text-white py-12 md:mt-32 px-4 sm:px-6 lg:px-8 mx-3 mt-8">
